...
import { getDetallesCompra, getDetalleCompraById, createDetalleCompra, updateDetalleCompra, deleteDetalleCompra, actualizarCosto} from '../controllers/detallesCompraController.js';
...
router.put('/:id/costo', actualizarCosto); 
